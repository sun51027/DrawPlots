...
void Draw_MC_allPlots()
{
	...
	for(int y=1;y<2;y++){
	  for(int m=0;m<3;m++){
		...
		string plotName[10] = { "NoCut_","N1_Quality_","N1_Energy_","N1_F51_","N1_dEdxSig_","N1_"
					,"Flow_Quality_","Flow_Energy_","Flow_F51_","Flow_dEdxSig_"};	
		string histogram[10] = { "","N_1_Quality_","N_1_Energy_","N_1_F51_",
					"N_1_dEdxSig_","N_1_","Flow_Quality_",
					"Flow_Energy_","Flow_F51_","Flow_dEdxSig_"};
